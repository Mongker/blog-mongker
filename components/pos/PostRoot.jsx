...
function PostRoot() {
    const dataMeta = {
        ...
        description: 'Dịch vụ đáo thẻ tín dụng Anh Đức (0888.589.678) đã hoạt động được \\/n 5 năm và có được sự tin tưởng của hơn 200k người dùng toàn Thanh Hóa, với sự phục vụ hết mình chúng tôi đem đến cho bạn những giá trị mà bạn cần. Hãy cầm điện thoại và gọi ngay 0888.589.678 để nhận những gì bạn cần nào !',
    }
    return(
        <React.Fragment>
            <MetaView {...dataMeta} />
